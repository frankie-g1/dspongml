...
def main():
    ...
    with open('pong_data.csv', mode='w') as train_file:
        ...
        train_file.writerow(
            ['ball_x', 'ball_y', 'ball_vx', 'ball_vy', "paddle_direction", "paddle_y", "Ball.RADIUS", "Paddle.L",
             "Paddle.STEP", "WIDTH", "HEIGHT", "BORDER", "VELOCITY", "FPS"])

    # write to a CSV file for training
    with open('pong_data.csv', mode='a') as train_file:
        train_file = csv.writer(train_file, delimiter=',', quotechar='"', quoting=csv.QUOTE_MINIMAL)
        train_file.writerow(
            [b0.x, b0.y, b0.vx, b0.vy, dir, p0.y, Ball.RADIUS, Paddle.L, Paddle.STEP, CONSTS.WIDTH, CONSTS.HEIGHT,
    ...
    while running:
        ...
        if not train:  # deploy model
            ...
            # complete this to predict using your model! full write: train_file.writerow([b0.x, b0.y, b0.vx, b0.vy,
            # dir, p0.y, Ball.RADIUS, Paddle.L, Paddle.STEP, CONSTS.WIDTH, CONSTS.HEIGHT, CONSTS.BORDER,
